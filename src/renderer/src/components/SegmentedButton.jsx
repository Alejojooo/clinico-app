...
export default function SegmentedButton({ label, icon, rounded }) {
  let buttonClassName =
    'flex flex-row justify-center items-center gap-2 px-3 py-2.5 h-10 w-40 border-y border-accent hover:bg-secondary-light focus:bg-tertiary transition-colors'
